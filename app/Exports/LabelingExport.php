...
class LabelingExport implements FromCollection, WithHeadings, WithTitle, WithEvents
{
    protected $mahasiswa;
    protected $idKelas;
    protected $idLevel;
        ...
        foreach ($mahasiswaData as $item) {
            foreach ($levels as $level) {
                ...
                foreach ($soalList as $soal) {
                    ...
                    // Get label for this specific combination
    ...
    {
        return ['NIM', 'Nama', 'Kelas (Angkatan)', 'Level', 'Soal', 'Pre-Test', 'Post-Test', 'Drag and Drop', 'Total Waktu', 'Total Waktu (Detik)', 'Label'];
    }
