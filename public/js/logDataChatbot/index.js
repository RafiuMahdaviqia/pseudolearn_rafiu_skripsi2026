...
initTable = () => {
    ...
    return new Promise((resolve, reject) => {
        var table = $("#table-log-data-chatbot").DataTable({
            ajax: {
            ...
            columnDefs: [
                ...
                },
                {
                    targets: 4,
                    render: function (data, type, row) {
                        let count = row.jumlah_chatbot ?? 0;
                        return `<span class="badge badge-light-primary fs-7">${count}</span>`;
                    },
                },
                {
                    targets: 5,
                    render: function (data, type, row) {
                        let count = row.jumlah_chatbot_adaptive ?? 0;
                        return `<span class="badge badge-light-info fs-7">${count}</span>`;
                    },
                },
                {
                    targets: 6,
