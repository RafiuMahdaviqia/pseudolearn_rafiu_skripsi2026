    ...
    <div id="kt_app_sidebar_navs_wrappers" class="app-sidebar-wrapper hover-scroll-y my-2" data-kt-scroll="true"
        ...
        <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
            ...
            @if ($isAdmin)
                ...
                <div class="menu-item">
                    <a class="menu-link{{ request()->is('log-data-chatbot*') ? ' active' : '' }}" href="{{ url('log-data-chatbot') }}">
                        <span class="menu-icon me-2">
                            <i class="ki-solid ki-message-text-2 fs-2"></i>
                        </span>
                        <span class="menu-title {{ request()->is('log-data-chatbot*') ? 'fw-bold' : 'fw-semibold' }}">Log Data Chatbot</span>
                    </a>
                </div>
                <div class="menu-item">
